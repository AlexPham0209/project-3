    ...
    return (
        <Form className='course-form' onSubmit={onSubmit}>
            <Form.Group className='text-bar' controlId='name'>
                ...
                <Form.Control className='text-input' type="name" placeholder='Enter Name' disabled={credits !== null}></Form.Control>
            </Form.Group>
            
            <Form.Group className='text-bar' controlId='credits'>
                <Form.Label className='text-description'>Total Transfer Credits</Form.Label>
                <Form.Control className='text-input' type="name" placeholder='Enter Credits' disabled={credits !== null}></Form.Control>
            </Form.Group>
